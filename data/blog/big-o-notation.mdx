...
The above code will run n times. The time complexity of this code is O(2^n) and the space complexity is O(n). This things is called exponential time complexity. Thanks to (Bastian Le Gall)[https://www.showwcase.com/show/18560/big-o-notation-in-javascript], I'm very interested to create a post about this.
